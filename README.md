...
1. **Abstract Factory** : le but du pattern **Abstract Factory** est la création d'objets regroupés en familles 
sans devoir connaître les classes concrètes destinées à la création de ces objets.

2. **Builder** : le but du pattern **Builder** est d'abstraire la construction d'objets complexes 
